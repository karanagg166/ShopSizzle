...
const GiftCouponCard = () => {
    ...
    // Initialize with coupon code if available
    const initialCode = useMemo(() => coupon?.code || "", [coupon?.code]);
    const [userInputCode, setUserInputCode] = useState(initialCode);
    ...
    // Sync coupon code once when it becomes available
    useEffect(() => {
        if (coupon && !hasSynced) {
